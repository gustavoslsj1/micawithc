  ...
  const lista = [
    {
      ...
      NotaGugu: 5.5,
      NotaMika: 5,
      synopsis: "Ekirie tenta escapar de sua cidade, Kurouzu-cho, onde os moradores ficam obcecados por espirais devido a uma maldição inexplicável."
    },
    {
      title: "Akame ga kill",
      type: "anime",
      ...
      NotaGugu: 7.5,
      NotaMika: 7.5,
      synopsis: "O jovem Tatsumi viaja para a capital do Império para ganhar dinheiro para seu povo faminto e acaba se envolvendo com a Night Raid, um grupo de assassinos que luta contra a corrupção do governo."
    },
    {
      title: "You",
      type: "Serie",
      ...
      NotaGugu: 9.5,
      NotaMika: 9,
      synopsis: "Série de suspense psicológico que acompanha Joe Goldberg, um homem aparentemente gentil que se torna perigosamente obcecado pelas pessoas que ama."
    },
    {
      title: "Re Life",
      type: "anime",
      ...
      NotaGugu: 8,
      NotaMika: 8.5,
      synopsis: "Arata Kaizaki recebe a chance de refazer a vida ao voltar ao ensino médio por um ano, enfrentando amadurecimento, amizades e escolhas difíceis."
    },
    {
      title: "Chainsaw Man",
      type: "anime",
      ...
      NotaGugu: 9,
      NotaMika: 8,
      synopsis: "Denji se funde ao demônio Pochita e passa a caçar demônios como uma arma humana em um mundo violento e cruel."
    },
    {
      title: "Grand Blue",
      type: "anime",
      ...
      NotaGugu: 7.5,
      NotaMika: 8.5,
      synopsis: "Iori Kitahara entra para um clube de mergulho e acaba vivendo situações caóticas cheias de festas, exageros e amizade."
    },
    {
      ...
      NotaGugu: 10,
      NotaMika: 9,
      synopsis: "David Martinez tenta sobreviver em Night City e se envolve com mercenários em uma história trágica sobre ambição, perda e humanidade."
    },
    {
      title: "Exterminio 2",
      type: "filme",
      ...
      NotaGugu: 7.5,
      NotaMika: 7,
      synopsis: "Após o suposto controle do vírus da raiva, uma falha humana provoca um novo surto que mergulha Londres novamente no caos."
    },
    {
      title: "Metal Lords",
      type: "filme",
      ...
      NotaGugu: 7,
      NotaMika: 9.5,
      synopsis: "Dois adolescentes formam uma banda de heavy metal para competir em um festival escolar, lidando com amizade e identidade."
    },
    {
      ...
      NotaGugu: 6,
      NotaMika: 10,
      synopsis: "Kiki, uma jovem bruxa, cria um serviço de entregas enquanto aprende a viver sozinha e a confiar em si mesma."
    },
    // {
    //   title: "Black Mirror",
    //   type: "serie",
    ...
    // },
    {
      ...
      NotaGugu: 6.5,
      NotaMika: 8,
      synopsis: "Após tirar a própria vida, um homem é condenado a viver várias mortes em corpos diferentes, refletindo sobre culpa e redenção."
    },
    {
      title: "Cães de caça",
      type: "serie",
      ...
      NotaGugu: 6,
      NotaMika: 8,
      synopsis: "Dois jovens lutadores enfrentam agiotas violentos no submundo do crime, unidos por lealdade e justiça."
    },
    {
      ...
      NotaGugu: 7,
      NotaMika: 10,
      synopsis: "Victor se vê dividido entre o mundo dos vivos e dos mortos após se casar acidentalmente com uma noiva do além."
    },
    {
      title: "Premonição 1",
      type: "filme",
      ...
      NotaGugu: 8,
      NotaMika: 7,
      synopsis: "Um grupo de jovens escapa da morte após uma premonição, mas passa a ser perseguido por um destino inevitável."
    },
    {
      title: "Premonição 3",
      type: "filme",
      ...
      NotaGugu: 8.5,
      NotaMika: 8.5,
      synopsis: "Uma adolescente tenta enganar a morte após prever um acidente, mas eventos trágicos seguem um padrão mortal."
    },
    {
      title: "Premonição 6",
      type: "filme",
      ...
      NotaGugu: 8,
      NotaMika: 8,
      synopsis: "Uma nova história mostra que interferir no destino pode ter consequências fatais que atravessam gerações."
    },
    {
      title: "Paranorman",
      type: "filme",
      ...
      NotaGugu: 6,
      NotaMika: 9,
      synopsis: "Norman, um garoto que fala com os mortos, precisa salvar sua cidade enfrentando fantasmas e preconceitos."
    },
    {
            ...
            <ul className=" gap-4 flex flex-col ">
              {lista
                ?.sort((a, b) => {
                  ...
                  const rankingA =
                    a.NotaGugu && a.NotaMika ? (a.NotaGugu + a.NotaMika) / 2 : a.NotaGugu;
                  const rankingB =
                    b.NotaGugu && b.NotaMika ? (b.NotaGugu + b.NotaMika) / 2 : b.NotaMika;
                      ...
                      <p className="font-bold text-gray-500">
                        ...
                        <span className="text-yellow-500 font-bold mx-1 ">
                          ...
                          <span className="text-purple-900 mx-5 font-bold">
                            Nota Mika: {item.NotaMika}{" "}
                            <span className="font-bold mx-5">+</span>
                          </span>
                          <span className=" font-bold text-cyan-600">
                            Nota Gugu: {item.NotaGugu}
                          </span>
                        </span>
                      </p>
                    </li>
